...
export const socialMedia: socialMediaNavigation[] = [
    {url: 'https://www.instagram.com/mobilerast/', text: 'Youtube', img: 'assets/img/social-media/youtube.svg', alt: 'Youtube'},
    ...
    {url: 'https://www.linkedin.com/company/rastmobile/', text: 'Linkedin', img: 'assets/img/social-media/linkedin.svg', alt: 'LinkedIn'},
]
