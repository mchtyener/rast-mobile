...
@Component({
  selector: 'app-social-media-pager',
  standalone: true,
  imports: [
    NgForOf
  ],
  templateUrl: './social-media-pager.component.html',
  styleUrl: './social-media-pager.component.scss',
  host: {
    class: 'datatable-pager'
  },
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class SocialMediaPagerComponent {
